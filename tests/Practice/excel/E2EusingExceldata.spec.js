...
import { readExcelData } from "./ExcelDataD.js";

const filepath =
  "C:/Users/david.doggala/OneDrive - ascendion/Desktop/PlayWrightExample/tests/Practice/excel/E2Edata.xlsx";

const dataset = await readExcelData(filepath, "Sheet1");

for (const data of dataset) {
  test(`Product Ordering E2E using POM ${data.productName} `, async ({
    browser,
  }) => {
