...
- Name: Test3
- Location: C:\Users\david.doggala\OneDrive - ascendion\Desktop\PlayWrightExample\tests\Reports\reports.spec.js:14:5
...
Call log:
  - navigating to "https://testautomationpractice.blogspot.com/#", waiting until "load"
    ...
    at C:\Users\david.doggala\OneDrive - ascendion\Desktop\PlayWrightExample\tests\Reports\reports.spec.js:15:16
```
...
```ts
   ...
   5 |     await expect(page).toHaveTitle('OrangeHRM')
   6 |     await page.close()
   7 | })
   8 | test('Test2', async ({ page }) => {
   9 |     await page.goto('https://www.demoblaze.com/index.html')
  10 |     await page.waitForTimeout(2000)
  11 |     await expect(page).toHaveTitle('STORE')
  12 |     await page.close()
  13 | })
  14 | test('Test3',  async ({ page }) => {
> 15 |     await page.goto('https://testautomationpractice.blogspot.com/#')
     |                ^ Error: page.goto: Test timeout of 30000ms exceeded.
  16 |     await expect(page).toHaveTitle('Automation Testing Practice')
  17 |     await page.close()
  18 | })
```