...
- Location: C:\Users\david.doggala\OneDrive - ascendion\Desktop\PlayWrightExample\tests\Dropdown\MultiSelectDropdown.spec.js:3:5
...
Call log:
  - navigating to "https://testautomationpractice.blogspot.com/#", waiting until "load"
    ...
    at C:\Users\david.doggala\OneDrive - ascendion\Desktop\PlayWrightExample\tests\Dropdown\MultiSelectDropdown.spec.js:4:16
```
...
>  4 |     await page.goto('https://testautomationpractice.blogspot.com/#');
     |                ^ Error: page.goto: Test timeout of 30000ms exceeded.
   5 |
   6 |     await page.selectOption("//select[@id='colors']" , ['red' , 'blue' , 'green' , 'yellow'])
   7 |     const options = await page.$$("//select[@id='colors']/option");
   8 |     console.log(options.length);
   9 |
  10 |     let flag = false;
