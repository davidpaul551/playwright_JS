...
```
Error: locator.isVisible: Error: strict mode violation: locator('text=2050') resolved to 2 elements:
...
Call log:
    - checking visibility of locator('text=2050')

    at C:\Users\david.doggala\OneDrive - ascendion\Desktop\PlayWrightExample\tests\Practice\Calendar.spec.js:25:49
```
