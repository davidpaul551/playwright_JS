...
Call log:
  - waiting for locator('.react-date-picker__inputGroup input').nth(4)

    at C:\Users\david.doggala\OneDrive - ascendion\Desktop\PlayWrightExample\tests\Practice\Calendar.spec.js:26:43
```
...
> 26 |         const value = await inputs.nth(i).getAttribute('value')
  ...
  28 |         expect(value).toEqual(expectList[i-1])
  29 |     }
  30 | })
```