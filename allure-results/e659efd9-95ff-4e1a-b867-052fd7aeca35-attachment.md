...
Expected string: "Thankyou"
Received string: " Thankyou for the order. "
Call log:
  - expect.toHaveText with timeout 5000ms
  - waiting for locator('.hero-primary')
    6 × locator resolved to <h1 class="hero-primary" _ngcontent-yok-c39=""> Thankyou for the order. </h1>
      - unexpected value " Thankyou for the order. "

    at C:\Users\david.doggala\OneDrive - ascendion\Desktop\PlayWrightExample\tests\Practice\E2EOrder.spec.js:61:49
```
...
```ts
  ...
  60 |
> 61 |     await expect(page.locator(".hero-primary")).toHaveText("Thankyou" , {contains:true})
     |                                                 ^ Error: Timed out 5000ms waiting for expect(locator).toHaveText(expected)
  62 |
