...
Call log:
  - waiting for locator('//button[normalize-space()=\'Clear\']') to be visible
    50 × locator resolved to hidden <button class="btn btn-primary btn-rounded cart-clear btn-danger">Clear</button>
...
- link "thumbnail of Blue Energy Potion Blue Energy Potion $4.99":
  - /url: https://web-scraping.dev/product/5
  - img "thumbnail of Blue Energy Potion"
  - heading "Blue Energy Potion" [level=3]
  - text: $4.99
- link "thumbnail of Dragon Energy Potion Dragon Energy Potion $4.99":
  - /url: https://web-scraping.dev/product/18
  - img "thumbnail of Dragon Energy Potion"
  - heading "Dragon Energy Potion" [level=3]
  - text: $4.99
- link "thumbnail of Dark Red Energy Potion Dark Red Energy Potion $4.99":
  - /url: https://web-scraping.dev/product/14
