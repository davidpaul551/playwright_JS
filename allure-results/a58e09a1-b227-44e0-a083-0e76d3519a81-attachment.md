...
Expected: "6"
Received: {Symbol(async_id_symbol): 8843, Symbol(trigger_async_id_symbol): 8764, Symbol(kResourceStore): undefined}
...
```ts
  ...
  26 |         const value = inputs.nth(i).getAttribute('value')
